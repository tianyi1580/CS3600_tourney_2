...
class Orchestrator:
    ...
    def _get_adversarial_overrides(self, runtime: RuntimeState) -> dict:
        ...
        if counts[OpponentCategory.PLAIN] / total > 0.35:
    ...
    def select_action(
        ...
        *,
        ...
        lambda_denial = float(adv_overrides.get("lambda_denial", self.weights.get("lambda_denial", 0.3)))
        ...
        # v4.1 FIX: Low peak means we should be MORE cautious, not "panic search."
        if our_peak < 0.20:
