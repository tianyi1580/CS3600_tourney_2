...
class PlayerAgent(ConfiguredPlayerAgent):
    """Default engine entrypoint for this submission package."""
    ...
    def __init__(self, board, transition_matrix=None, time_left: Callable = None):
        super().__init__(
            ...
            transition_matrix,
            time_left,
            commentate_name="yolanda_prime_v1_2Test",
        )
