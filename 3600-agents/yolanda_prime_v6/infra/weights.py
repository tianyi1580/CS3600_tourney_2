...
_SPECS: tuple[ParameterSpec, ...] = (
    ...
    ParameterSpec("time_opening_multiplier", 1.20, 0.5, 3.0, "D"),
    ParameterSpec("time_mid_multiplier", 1.00, 0.5, 3.0, "D"),
    ParameterSpec("time_late_multiplier", 0.80, 0.5, 2.5, "D"),
    ParameterSpec("time_complex_min", 0.70, 0.3, 1.0, "D"),
    ParameterSpec("time_complex_max", 2.00, 1.0, 3.0, "D"),
    ParameterSpec("time_reserve", 5.0, 1.0, 12.0, "D"),
    ParameterSpec("time_fraction_cap", 0.15, 0.05, 0.40, "D"),
)
