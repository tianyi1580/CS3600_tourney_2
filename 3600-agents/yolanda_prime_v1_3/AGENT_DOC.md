...
# think at margins: small optimization = when down <4 at end always guess rat if cannot get points, need to be aware of final turn dynamics to make sure we win close games
