...
def infer_opponent_category(
    ...
    if loc_now is not None and res_now in (True, False) and (loc_now, res_now) != (loc_snap, res_snap):
        return OpponentCategory.SEARCH
...
__all__ = ["OpponentCategory", "infer_opponent_category", "parse_search_tuple"]
