...
class PolicyEngine:
    ...
    def score_non_search(
        ...
        centrality_scale = 1.5 if phase == "opening" else (1.0 if phase == "mid" else 0.3)
    ...
    def select_action(
        ...
        # Opening principle (§1.1): build infrastructure first; avoid early carpets.
        if phase == "opening":
            non_carpet = [m for m in non_search_candidates if m.move_type != MoveType.CARPET]
            if non_carpet:
                non_search_candidates = non_carpet
