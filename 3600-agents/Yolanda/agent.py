...
class PlayerAgent:
    ...
    def __init__(self, board, transition_matrix=None, time_left: Callable = None):
        ...
        self.runtime_state.enable_adaptive_margin = _env_flag("YOLANDA_ENABLE_ADAPTIVE_MARGIN", True)
    ...
    def commentate(self):
        rs = self.runtime_state
        return (
            "v4 M3: M2 tactical core + bounded opponent adaptation + strict search margin "
