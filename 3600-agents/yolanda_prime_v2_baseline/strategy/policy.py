...
class PolicyEngine:
    ...
    def _carpet_risk_profile(
        ...
        *,
        ...
        counter_floor = guaranteed + (1.0 if turns_left > 28 else 2.0)
    ...
    def _search_gate(
        ...
        if state.farmable_rat:
            q_best_non *= 0.90
            guess_margin = 0.22 + 0.22 * turn_fraction + lead_adjustment
        else:
            guess_margin = 0.35 + 0.50 * turn_fraction + lead_adjustment
