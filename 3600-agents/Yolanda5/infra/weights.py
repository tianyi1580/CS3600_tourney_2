...
class ParameterSpec:
    """Single scalar exposed through the Yolanda5 weight interface."""
...
_SPECS: tuple[ParameterSpec, ...] = (
    ...
    ParameterSpec("nonfarm_margin_base", 0.25, 0.0, 0.5),
...
def load_weights(
    *,
    ...
    env_var: str = "Y5_WEIGHTS_JSON",
    weights_file_name: str = "weights.json",
    allow_env: bool = True,
) -> tuple[dict[str, float], str]:
    """Load safe weight overrides for Yolanda5 and report their source."""
