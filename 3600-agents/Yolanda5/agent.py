...
class ConfiguredPlayerAgent:
    ...
    def commentate(self):
        rs = self.runtime_state
        return (
            f"{self.commentate_name}: Conservative Shallow Search + Structural Leaf Eval "
...
class PlayerAgent(ConfiguredPlayerAgent):
    """Default Yolanda5 entrypoint with safe local/env weight loading."""
