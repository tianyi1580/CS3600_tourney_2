...
_SPECS: tuple[ParameterSpec, ...] = (
    ...
    # Tier B: search / planner biases.
    ParameterSpec("planner_bias", 2.0, 0.0, 6.0, "B"),
    ParameterSpec("territory_opp_margin", 1.0, 0.0, 3.0, "B"),
    ParameterSpec("chain_potential_scale", 0.70, 0.1, 1.5, "B"),
